...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-bootstrap5-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14807&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-bootstrap5-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-bootstrap5` can be installed with:

```
conda install django-bootstrap5
```

It is possible to list all of the versions of `django-bootstrap5` available on your platform with:
